    ...
    ***************************************************************************** */
    ...
    var ProcessExtendsVisitor = /** @class */ (function () {
        ...
        ProcessExtendsVisitor.prototype.checkExtendsForNonMatched = function (extendList) {
            var sommarios = this.extendSommarios;
            extendList.filter(function (extend) {
                ...
                if (!sommarios[extend.index + " " + selector]) {
                    sommarios[extend.index + " " + selector] = true;
    ...
    //    It also takes care of moving all the sommarios forwards.
    //

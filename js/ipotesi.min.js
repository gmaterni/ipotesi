...
const opHome=function(a){MgrUi.showSommario();toggleMenu();UaWindowAdm.closeAll()},opArchivio=function(a){MgrUi.showIndici();toggleMenu();UaWindowAdm.closeAll()},opHelp=function(){toggleMenu();UaWindowAdm.closeAll();wnds.wdiv.open("./html/help0.html")},opNews=function(a){toggleMenu();UaWindowAdm.closeAll();wnds.wdiv.open("./html/help1.html")},opRedazione=function(a){toggleMenu();UaWindowAdm.closeAll();wnds.wdiv.open("./html/redazione.html")},opCollaboatori=function(a){alert("collaboratori")},opIPOTESI=
...
function toggleMenu(){document.querySelector(".menu-h").classList.toggle("active");document.body.classList.toggle("open-menu")}function getTheme(){const a=localStorage.getItem("theme");a&&"dark"==a&&setDark()}function setLight(){document.documentElement.classList.toggle("invert");document.body.classList.remove("theme-dark");document.body.classList.add("theme-light");localStorage.setItem("theme","ligth")}
function setDark(){document.documentElement.classList.toggle("invert");document.body.classList.remove("theme-light");document.body.classList.add("theme-dark");localStorage.setItem("theme","dark")}function invertColors(){document.querySelectorAll("*").forEach(a=>{a.classList.add("invert-colors")})}function enableEsc(a){document.addEventListener("keydown",cmdEsc);a&&("Escape"!==a.key&&27!==a.keyCode||cmdEsc())}function disableEsc(a){document.removeEventListener("keydown",cmdEsc)}
function cmdEsc(){closeReader()}const imageCarousel=()=>{const a=document.querySelector(".col-right");a.querySelectorAll(".item0").forEach(c=>{c.classList.add("active")});setInterval(()=>{const c=a.querySelector(".item0");a.appendChild(c)},5E3)};let fontSize=18;const fsizeDef=18,fsizeMax=32,fsizeMin=14,fsizeKey="fsize_reader";var textCurrent="";const fh=a=>`
